...
;  So, we fixed the hardware bug using software code.
;
...
uart_tx_wait_loop:
  ...
  JSR uart_tx_delay ; 6 clock cycle
...
uart_tx_delay:
  PHX ; 3 clock cycle
  LDX #100 ; 2 clock cycle
uart_tx_delay_loop:
  DEX ; 2*100 clock cycle
  BNE uart_tx_delay_loop ; 3*100 clock cycle
  PLX ; 4 clock cycle
  RTS ; 6 clock cycle
