...
RESET:          CLD             ; Clear decimal arithmetic mode.
                JSR INIT_BUFFER ; initialize the string buffer
                CLI
                ...
                LDY #$89        ; parity mode disable, not use echo mode, disable interrupt, IRQB enable, data terminal ready although we don't use it
                STA ACIA_CMD
...
NEXTCHAR:       JSR CHRIN       ; check input that we need to read exists
                BCC NEXTCHAR    ; if not, looping
